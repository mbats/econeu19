 ...
 * @generated
 */
public class MindstormsActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(MindstormsEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			@Override
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(MindstormsEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			@Override
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(MindstormsEditorPlugin.INSTANCE.getString("_UI_MindstormsEditor_menu"), "fr.obeo.dsl.tuto.mindstormsMenuID");
		...
		//
		createChildMenuManager = new MenuManager(MindstormsEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(MindstormsEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
